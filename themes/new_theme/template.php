...
<body class="skin-blue">
    ...
    <header class="header">
        <a href="<?= $this->config->item('base_url') ?>admin/dashboard" class="logo"><img src="<?= $theme_path; ?>/images/esoft1.png" /> <!--<small>e-learning</small>--></a>
                    ...
                    <ul class="sidebar-menu sidebar-ul">
                        ...
                        if ($user_det['staff_type'] == 'admin') {
                            ...
                            <li class="treeview">
                                ...
                                if ($this->uri->segment(1) != 'report' && ($this->router->fetch_class() == 'batch' || $this->router->fetch_class() == 'designation' || $this->router->fetch_class() == 'semester' || $this->router->fetch_class() == 'department' || $this->router->fetch_class() == 'group' || $this->router->fetch_class() == 'master' || $this->router->fetch_method() == 'college_mark_details' || $this->router->fetch_class() == 'exam' || $this->router->fetch_class() == 'board' || $this->router->fetch_class() == 'student' || $this->router->fetch_class() == 'staff' || $this->router->fetch_class() == 'subject' || $this->router->fetch_method() == 'manage_admin' || $this->router->fetch_method() == 'college_fees_details')) {
                                    echo 'block';
                                } else {
                                    echo 'none';
                                }
                                ?>">
                                    ...
                                    <li class="<?= ($this->router->fetch_class() == 'board') ? 'active' : '' ?>">
                                        <a href="<?= $this->config->item('base_url'), 'board' ?>">
                                            <i class="fa fa-angle-double-right"></i> <span>Board</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="<?= ($this->router->fetch_class() == 'staff') ? 'active' : '' ?>">
                                        <a href="<?= $this->config->item('base_url'), 'staff' ?>">
                                            <i class="fa fa-angle-double-right"></i> <span>Staff</span>
                                            <span class="selected"></span>
                                        </a>
                                    </li>
                                    <li class="<?php
                                    ...
                                    ?>">
                                        <a href="<?= $this->config->item('base_url'), 'student' ?>">
                                            <i class="fa fa-angle-double-right"></i> <span>Student</span>
                                            <span class="selected"></span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="<?= ($this->router->fetch_class() == 'subject') ? 'active' : '' ?>">
                                        <a href="<?= $this->config->item('base_url'), 'subject' ?>">
                                            <i class="fa fa-angle-double-right"></i> <span>Subject</span>
                                            <span class="selected"></span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        if ($permission[0]['attendance'] == 1) {
                            ...
                            <li class="treeview">
                                ...
                                if ($this->uri->segment(1) != 'report' && ($this->router->fetch_class() == 'leave' || $this->router->fetch_class() == 'attendence' || $this->router->fetch_class() == 'attendance_od_ml' || $this->router->fetch_class() == 'attendance_report' || $this->router->fetch_class() == 'staff_attendence')) {
                                    echo 'block';
                                } else {
                                    echo 'none';
                                }
                                ?>">
                                    ...
                                    <?php if ($user_det['staff_type'] == 'admin') { ?>
                                        <li class="<?php echo ($this->router->fetch_class() == 'staff_attendence' && $this->router->fetch_method() == 'index') ? 'active' : '' ?>">
                                            <a href="<?= $this->config->item('base_url'), 'staff_attendence/' ?>">
                                                <i class="fa fa-angle-double-right"></i><span>Staff Attendance</span>
                                            </a>
                                        </li>
                                        <li class="<?php echo ($this->router->fetch_class() == 'staff_attendence' && $this->router->fetch_method() == 'staff_attendance_report') ? 'active' : '' ?>">
                                        ...
                                        <li class="<?php echo ($this->router->fetch_class() == 'leave' && $this->router->fetch_method() == 'manage_leave') ? 'active' : '' ?>">
                                            <a href="<?php echo $this->config->item('base_url'), 'leave/manage_leave' ?>">
                                                <i class="fa fa-angle-double-right"></i> <span>Manage Staff Leave</span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if ($user_det['staff_type'] == 'staff') { ?>
                                        <li class="<?php echo ($this->router->fetch_class() == 'leave') ? 'active' : '' ?>">
                                            <a href="<?php echo $this->config->item('base_url'), 'leave' ?>">
                                                <i class="fa fa-angle-double-right"></i> <span>Leave</span>
                                                <span class="selected"></span>
                                            </a>
                                        </li>
                            ...
                            <li class="treeview" id="timetable">
                                ...
                                <ul class="treeview-menu" id="chat" style="display:<?php
                                if ($this->router->fetch_class() == 'time_table' || $this->router->fetch_class() == 'staff_table' || $this->router->fetch_method() == 'staff_time_table') {
                                    echo 'block';
                                } else {
                                    echo 'none';
                                }
                        ...
                        if ($permission[0]['internal_mark'] == 1) {
                            ?>
                            <li class="treeview <?php echo ($this->uri->segment(1) != 'report' && ($this->router->fetch_class() == 'internal' || $this->router->fetch_class() == 'student_promotion')) ? 'active' : '' ?>">
                                <a href="#">
    ...
    <!--                                    <li class="<?= ($this->router->fetch_class() == 'internal' && $this->router->fetch_method() == 'internal_exam') ? 'active' : '' ?>">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" style="display:<?php
                            if ($this->uri->segment(1) != 'report' && ($this->router->fetch_class() == 'assignment' || $this->router->fetch_method() == 'staff_view' || $this->router->fetch_class() == 'notes' || $this->router->fetch_class() == 'events' || $this->router->fetch_class() == 'staff_tickets' || $this->router->fetch_method() == 'admin_view' || $this->router->fetch_class() == 'inventory' || $this->router->fetch_method() == 'college_calendar' || $this->router->fetch_method() == 'notice')) {
                                echo 'block';
                            } else {
                                echo 'none';
                            }
                        ...
                        if ($permission[0]['fee_details'] == 1) {
                            ...
                            <li class="treeview">
                                ...
                                ?>">
                                    ...
                                    <li class="<?= ($this->router->fetch_method() == 'non_dividing_hostel_report') ? 'active' : '' ?>">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu" id="att" style="display:<?php
                                if ($this->uri->segment(1) != 'report' && ($this->router->fetch_class() == 'fees' || $this->router->fetch_method() == 'exam_fees' || $this->router->fetch_method() == 'pay' || $this->router->fetch_method() == 'report')) {
                                    echo 'block';
                                } else {
                                    echo 'none';
                                }
                            ...
                            <li class="treeview">
                                ...
                                <!--<li class="<?= ($this->router->fetch_method() == 'bus_root_details') ? 'active' : '' ?>">
                                   ...
                                   <a href="<?= $this->config->item('base_url'), 'transport/add_driver' ?>">
                                    ...
                                    <li class="<?php
                                    if ($this->router->fetch_class() == 'transport' && $this->router->fetch_method() == 'transport_report') {
                                        echo 'active';
                                    } else {
                                        '';
                                    }
                                    ...
                                    <li class="<?php
                                    if ($this->router->fetch_class() == 'transport' && $this->router->fetch_method() == 'transport_addmission') {
                                        echo 'active';
                                    } else {
                                        '';
                                    }
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu" id="ass1" style="display:<?php
                            if ($this->uri->segment(1) == 'report' && ($this->router->fetch_method() == 'student_report' || $this->router->fetch_class() == 'attendance_report' || $this->router->fetch_method() == 'staff_attendance_report' || $this->router->fetch_method() == 'staff_view' || $this->router->fetch_method() == 'hostel_report' || $this->router->fetch_method() == 'non_dividing_hostel_report' || $this->router->fetch_method() == 'report' )) {
                                echo 'block';
                            } else {
                                echo 'none';
                            }
                            ?>">
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_class() == 'student' && $this->router->fetch_method() == 'student_report') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/student/student_report' ?>">
                                        <i class="fa fa-angle-double-right"></i> <span>Student Report</span>
                                    </a>
                                </li>
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_class() == 'attendance_report') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/attendance_report' ?>">
                                ...
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_class() == 'assignment') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/assignment/staff_view' ?>">
                                        <i class="fa fa-angle-double-right"></i> <span>Project</span>
                                    </a>
                                </li>
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_class() == 'internal') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/internal/student_report' ?>">
                                        <i class="fa fa-angle-double-right"></i> <span>Exam Result</span>
                                    </a>
                                </li>
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_method() == 'hostel_report') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/hostel/hostel_report' ?>">
                                        <i class="fa fa-angle-double-right"></i> <span>Dividing  Hostel Report</span>
                                    </a>
                                </li>
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_method() == 'non_dividing_hostel_report') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/hostel/non_dividing_hostel_report' ?>">
                                        <i class="fa fa-angle-double-right"></i> <span>Non Dividing  Hostel Report</span>
                                    </a>
                                </li>
                                <li class="<?php
                                if ($this->uri->segment(1) == 'report' && $this->router->fetch_class() == 'fees') {
                                    echo 'active';
                                } else {
                                    '';
                                }
                                ?>">
                                    <a href="<?= $this->config->item('base_url'), 'report/fees/report' ?>">
        ...
        <div class="main_footer">
            <div class="footer_style">Copyright 2018 Pupil-Soft - School Management. All rights reserved. Powered by <a href="http://www.f2fsolutions.co.in/" target="_blank"class="foot-color">f2f solutions</a></div>
        </div>
