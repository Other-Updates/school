        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $(".rightMenu-title").click(function () {
                    $("#info1").animate({height: 'toggle'});
                    "slow"
                });
                $(".rightMenu-title1").click(function () {
                    $("#info2").animate({height: 'toggle'});
                    "slow"
                });
            });
        </script>
    ...
    <body>
        ...
        <div class="row-body content-feed">
            ...
            <div class="three columns user_print_use three-mar">
                <div class="sidebar-container widget-welcome">
                    <div class="sidebar-content">
                        <div class="sidebar-header">Reg.no : <span class="reg-no"><?= $data['all'][0]['regno'] ?></span><?php /* ?>Welcome <span><?=ucfirst($user_det[0]['name'])?></span><?php */ ?></div>
            ...
            <!--                        <li><a href="<?= $this->config->item('base_url') . 'users/arrear_time_table' ?>"><i class="fa fa-angle-double-right"></i> Arrear Time Table</a></li>-->
                            ...
                            <li><a href="<?= $this->config->item('base_url') . 'users/student_view' ?>"><!--img src="<?= $theme_path; ?>/images/icons/events/assignment.png" class="rotate">--><i class="fa fa-edit adm-icon"></i> Project</a></li>
            ...
            <div class="footer">
                ...
                <div class="footer-container">
                    <div class="footer-languages">
                        Copyright &copy; 2018  Pupil Soft - School Management. All rights reserved. Powered by <a href="http://www.f2fsolutions.co.in/" target="_blank">f2f Solutions</a>.
                    </div>
                </div>
