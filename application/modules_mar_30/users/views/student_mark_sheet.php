                ...
                if (empty($from_report)) {
                    ...
                    <table class="view_table"  width="100" >
                        ...
                        <tr>
                            ...
                            <td colspan="2" rowspan="3"><img id="blah" style="height:100px;width:100px;" class="add_staff_thumbnail" src="<?= $this->config->item('base_url'); ?>/profile_image/student/orginal/<?= $student_info[0]['image'] ?>"  alt="Student Image" /></td>
                        </tr>
                        <tr>
                            <td>SCHOOL</td>
