  	...
  	<div class="modal-body">
        ...
        <td><input type="hidden" name="id" class="id form-control" id="id" value="<?php echo $billto["id"]; ?>" readonly /></td>
         ...
         <td><input type="text" class="nickname"  name="nickname" value="<?php echo $billto["nickname"];?>" />
          <input type="hidden" class="nickname_hidden" value="<?php echo $billto["nickname"]; ?>" /><span class="nick_error" style="color:#F00;"></span></td>
         </tr>
         <tr>
         <td><strong>Status:</strong></td>
         <td>
         <select name="status" id="status" class="status form-control" class="mandatory">
...
<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">Delete Department</h3>
