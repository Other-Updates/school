...
<table width="100%" border="0" class="form_table">
    <tr>
       <td width="110"><b>Add Designation</b></td>
        <td><input type="text" name="designation"  value="" class="mandatory mandatory6" placeholder="Enter Designation"  id="name" maxlength="50"/> </td>
    <tr>
...
<div id="test_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
  ...
  <div class="modal-content">
    ...
    <h3 id="myModalLabel">Designation View</h3>
    </div>
  <div class="modal-body">
  <table width="100%" class="staff_table_sub">
        <tr>
        <?php /*?><td><strong>S.No</strong></td> <td><?php echo $billto["id"]; ?></td></tr><tr><?php */?>
        <td><strong>Designation</strong></td> <td class="text_bold1"><?php echo $billto["designation"]; ?></td></tr><tr>
...
<div id="test1_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" 
  role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
  	...
  	<div class="modal-content">
    <div class="modal-header"><a class="close" data-dismiss="modal">×</a>   
    <h3 id="myModalLabel">Update Designation</h3>
    </div>
  	<div class="modal-body">
     	 <table width="100%">
         <tr>
        ...
        <td><input type="hidden" name="id" class="id form-control" id="id" value="<?php echo $billto["id"]; ?>" readonly="readonly" /></td>
         ...
         <td><input type="text" class="designation form-control" id="designation"   name="designation" value="<?php echo $billto["designation"]; ?>" /><span class="error_msg" style="color:#F00;"></span> <span class="error_msg1" style="color:#F00;"></span><input type="hidden" id="desg" class="desg" value="<?php echo $billto["designation"]; ?>" /></td>
         </tr>
         <tr>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <h3 id="myModalLabel">In-Active Designation</h3>
    </div>
  <div class="modal-body">
     Do You Want to In-Active? &nbsp; <strong><?php echo $billto["designation"]; ?></strong>
...
<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h4>Delete Designation</h4><h3 id="myModalLabel">
</div><div class="modal-body">
     Do you want delete Permanently? &nbsp; <strong><?php echo $billto["designation"]; ?></strong>
...
<script type="text/javascript">
 ...
 //	$("#name").focus();
  $("#submit").click(function()
  {
		 ...
		 $.ajax(
		 {
		  url:BASE_URL+"designation/insert_designation",
		  type:'POST',
		  data:{ value1 : name},
   ...
   $("#name").live('keyup',function()
  {
        var name=$("#name").val();	   
		 $.ajax(
		 {
		  url:BASE_URL+"designation/checking_designation",
		  type:'POST',
		  data:{ value1 : name},
		  success:function(result)
		  {
...
var designation=$(this).parent().parent().find(".designation").val();
  var i=0;
   ...
   var status=$(this).parent().parent().find('.status').val();
		  if (designation.trim().length<2 || designation.trim().length>50)
		   {
			   //alert("alert");
		  ...
		  $.ajax(
		 {
		  ...
		  type:'POST',
		  data:{ value1 : designation ,value2 : id},
     ...
     $.ajax({
      url:BASE_URL+"designation/update_designation",
      type:'POST',
      data:{ value1 : id,value2:designation,value3:status},
      success:function(result){
   ...
   $("#yes").live("click",function()
  {
   ...
   var hid=$(this).parent().parent().find('.hid').val();
    ...
    $.ajax({
      url:BASE_URL+"designation/delete_designation",
      type:'POST',
      data:{ value1 : hid},
    ...
    $("#no").live("click",function()
  {
   ...
   $c=designation=$(this).parent().parent().find('.designation').val(),
   $d=status=$(this).parent().parent().find('.status').val();
    designation=$(this).parent().parent().find('.designation').val(''),
	designation=$(this).parent().parent().find('.designation').val($a),
	 ...
	 $("#yesin").live("click",function()
  {
   ...
   var hidin=$(this).parent().parent().find('.hidin').val();
     ...
     $.ajax({
      url:BASE_URL+"designation/delete_designation_inactive",
      type:'POST',
      data:{ value1 : hidin},
