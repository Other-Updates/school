...
<div id="test_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
  ...
  <a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">View Designation</h3></div><div class="modal-body">
    ...
    <h3 id="myModalLabel">Update Designation</h3>
  	...
  	<div class="modal-body">
        ...
        <!-- <td><strong>Id:</strong></td>-->
         ...
         <td><input type="text" class="designation form-control" id="designation"  name="designation" value="<?php echo $billto["designation"]; ?>" /><input type="hidden" id="desg" class="desg" value="<?php echo $billto["designation"]; ?>" /><span class="error_msg" style="color:#F00;"></span> <span class="error_msg1" style="color:#F00;"></span></td>
         </tr>
         <tr>
...
<div id="test2_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
  <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">In-Active Designation</h3>
...
<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">Delete Designation</h3>
</div><div class="modal-body">
