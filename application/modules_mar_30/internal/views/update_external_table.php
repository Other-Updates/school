...
if (isset($all_grade[0]['external_details']) && !empty($all_grade[0]['external_details'])) {
    ?>
    <br />
    <a class="btn btn-primary" href='<?= $this->config->item('base_url') . 'internal/external_print/' . $ajax_value['batch_id'] . '/' . $ajax_value['depart_id'] . '/' . $ajax_value['group_id'] . '/' . $ajax_value['semester'] . '/' . $ajax_value['exam_id'] ?>'>View</a>
