    ...
    if (isset($all_grade[0]['external_details']) && !empty($all_grade[0]['external_details'])) {
        ...
        foreach ($all_grade[0]['external_details'] as $val) {
            ...
            <tr>
                ...
                <td><a href="<?= $this->config->item('base_url') . 'internal/mark_sheet/' . $val['std_id'] . '/' . $post_data['exam_id']; ?>" title="Mark Sheet" target="_blank" class="btn bg-navy btn-sm">View</a> </td>
            </tr>
            <?php
            $j++;
        }
...
if (isset($all_grade[0]['external_details']) && !empty($all_grade[0]['external_details'])) {
    ...
    <div class="admin_print_use ">
        <div class="right">
            ...
            <a class="btn btn-info" href='<?= $this->config->item('base_url') . 'internal/excel/' . $post_data['batch_id'] . '/' . $post_data['depart_id'] . '/' . $post_data['group_id'] . '/' . $post_data['semester'] . '/' . $post_data['exam_id'] ?>'>Excel</a>&nbsp;&nbsp;

            <a class="btn btn-warning" href='<?= $this->config->item('base_url') . 'internal/pdf/' . $post_data['batch_id'] . '/' . $post_data['depart_id'] . '/' . $post_data['group_id'] . '/' . $post_data['semester'] . '/' . $post_data['exam_id'] ?>'>PDF</a>
