<div class="box-body table-responsive">
    <table width="100%" border="0" class="form_table">
        <tr>
            ...
            <td width="120"><input type="text" name="department"  value="" class="mandatory mandatory6" placeholder="Enter Class" onkeypress="return validateAlphabets(event);" id="name"/><span id="errormessage" style="color:#F00;"></span><td><span id="color" style="color:#FC3;margin-left:30%"><h5><blink>You must add the group after class entry</blink></h5></span><br /></td></td>
        <tr>
            <td width="110"><b>Nick Name</b></td>
            <td><input type="text" name="nick_name" placeholder="Ex:10th" class="mandatory mandatory6 nick_name" id="nickname" /></td>
        </tr>
        <tr>
