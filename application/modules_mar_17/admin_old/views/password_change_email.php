...
if($student['type']=='college')
 echo "Your iboard site password has beed changed.<br />";
else
 echo "Your iboard social network password has beed changed.<br />";
 ?>	

Your new password is: <?php echo $student['pwd'];?><br /><br />
...
if(isset($student['from']) && !empty($student['from']))
 ...
 ?><br />
This account will allow you to see and interact with Students and Staffs. If you have any questions please contact us.<br />

</td>
<tr height="50"><td></td></tr>
<tr align="right" style="font-family:Arial,Helvetica,sans-serif;font-size:12px; font-weight:bold;color:#666666;"><td>Modified By: <?php echo ucfirst($student['created_by'])?></td></tr>   
</tr>    
<tr> 
