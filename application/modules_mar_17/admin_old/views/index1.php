...
<nav class="nav-ml mb wid-log nav-color">
	<ul class="tabs">
		<li class="ad-li"><a href="#section-1"><i class="icon-user icon-2x pull-left usr-col"></i><span class="usr-col">Admin Login </span></a></li>
...
<div class="admin_login">
    <div class="login_bg">
        ...
        <label class="login_label">
            ...
            <input type="text" name="email" placeholder="Email Id" id="emailid" class="soft-form input-wid" />
        </label>
        <label class="login_label">
            <i class="icon-lock login_icon log-col-ad"></i>
            <input type="password" name="upass" placeholder="Password" id="upass" class="soft-form input-wid"/>
        </label>
...
<div class="create-account wid-ad">
                    <p>
