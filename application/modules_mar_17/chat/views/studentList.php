    ...
    <div class="box-body">
        ...
        <div class="my_chat_img">
         <?php $image=$res->image;
										if($image!=""){
										 ?>
                                        <img class="staff_thumbnail" src="<?= $this->config->item('base_url').'profile_image/student/thumb/'?><?php echo $res->image; ?>" />
                                        <?php
										}
										else
										{
											?>
							<img class="staff_thumbnail" src="<?= $this->config->item('base_url').'profile_image/student/thumb/avatar5.png'?>" />	
										<?php
                                        }
										?>
        </div>
      ...
      <?php if($this->user_auth->get_username()==$res->name) { ?>
                   <div class="name" style="text-decoration:none"><?php echo $res->name; ?></div>
				   <?php } else { ?>  
