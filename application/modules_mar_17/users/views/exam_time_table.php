...
?>
<label class="field-name">Select Exam :</label>                                   
...
<div id='other_time_table'>
    ...
    <thead>
    <tr>
        <th colspan="5"><span style="color:#058DCE"><?php  echo $all_info[0]['sem'][0]['semester'];  ?> &nbsp; Exam Time Table</span></th>
    </tr>
    <tr>
        <th>S.No</th>
        <th>Subject</th>
...
<script type="text/javascript">
	$('#select_sem').live('change',function(){
		if($(this).val()!=''){
			$.ajax({	
			  url:BASE_URL+"users/get_exam_time_table/3",
			  type:'POST',
			  data:{ 
						int_id:$(this).val(),
