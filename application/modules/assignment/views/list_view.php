...
//echo "<pre>"; print_r($list); exit;
                                ...
                                <tr><td><?php echo $i; ?></td>
                                    ...
                                    <td><a href="#view_<?php
                                        ...
                                        ?>" data-toggle="modal" name="group" class="btn bg-maroon btn-sm"><i class="fa fa-eye"></i></a>
                                                                                                                                                                ...
                                                                                                                                                                <!--<a href="<?= $this->config->item('base_url') . 'assignment/view_assignment/' . $billto["id"]; ?>" data-toggle="modal" name="group" class="btn bg-navy btn-sm"><i class="fa fa-edit"></i></a>-->
                                        <a href="#delete_<?php
                                        if (isset($list[$j][$x]['id'])) {
                                            echo $list[$j][$x]['id'];
                                        }
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" >
                                    <table class="staff_table_sub">
                                        <tr>
                                            <td>Academic Year</td><td class="text_bold1"><?php echo $list[$j][$x]['from']; ?>  </td>
                                        </tr>
                                        <tr>
    ...
    if (isset($list) && !empty($list)) {
        ...
        foreach ($list as $billto) {
            ...
            ?>
            <tr><td><?php echo $i; ?></td>
                <td><?php echo $billto["from"] . "-" . $billto["to"]; ?></td>
                ...
                <td><?php
                    ...
                    ?></td>
                <td><?php echo $billto['subject_name']; ?></td>
