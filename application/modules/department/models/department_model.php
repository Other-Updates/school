...
class Department_model extends CI_Model {
    ...
    function get_department() {
        $this->db->select('department.*,board.board_type AS board_name');
        $this->db->where('department.df', 0);
        $this->db->join('board', 'board.id=department.board_type');
    ...
    function delete_department_inactive_check($id) {
        $query = $this->db->query("select a.id from notes a,student_group b,staff c,subject_details d where a.depart_id='$id' or b.depart_id='$id' or c.depart_id='$id' or d.depart_id='$id'");
