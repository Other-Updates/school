...
class Department extends MX_Controller {
    ...
    public function insert_department() {
        $this->load->model('department/department_model');
        $input = array('department' => $this->input->post('value1'), 'nickname' => $this->input->post('value2'), 'board_type' => $this->input->post('value3'));
    ...
    public function update_department() {
        ...
        if ($i == 1) {
            echo "<script type='text/javascript'>alert('Class Assign to some other place so can not be Update ');</script>";
            ...
            $input = array('department' => $this->input->post('value2'), 'status' => $this->input->post('value3'), 'nickname' => $this->input->post('value4'), 'board_type' => $this->input->post('value5'));
    ...
    public function delete_department() {
        ...
        if ($i == 1) {
            echo "<script type='text/javascript'>alert('class Assign to some other place so can not In-Active ');</script>";
