...
<?php
if (!empty($board[0]['id']) && $board[0]['id'] == 2) {
    ...
    if (isset($all_grade) && !empty($all_grade)) {
        ...
        foreach ($all_grade as $grade) {
            ...
            <table  class="table table-bordered table-striped dataTable">
                <thead>
                    <tr>
                        <th colspan="4" style="text-align:center"><?php echo strtoupper($grade['exam_name']); ?></th>
                    </tr>
                    <tr>
                ...
                if (isset($grade['external_details']) && !empty($grade['external_details'])) {
                    ...
                    foreach ($grade['external_details'] as $result1) {
                        ...
                        <tr>
                            ...
                            <td  style="text-align:center;width: 10%;"><?php echo ($result1['grade']) ? $result1['grade'] : '-'; ?></td>
                            <td  style="text-align:center;width: 10%;"><?php echo ($result1['grade'] == 0) ? 'FAIL' : 'PASS' ?></td>
                        </tr>
                        <?php
                    }
                } else
