    ...
    foreach ($list as $billto) {
        ...
        <div id="test_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header">
                        <a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">View Term</h3></div><div class="modal-body">
                        <table width="100%" class="staff_table_sub">
                            <tr>
                                <?php /* ?><td><strong>S.No</strong></td> <td><?php echo $billto["id"]; ?></td></tr><tr><?php */ ?>
                                <td><strong>semester</strong></td> <td class="text_bold1"><?php echo $billto["semester"]; ?></td></tr><tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel">Update Term</h3>
                    </div>
                        ...
                        <table width="100%">
                           ...
                           <!-- <td><strong>Id:</strong></td>-->
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="semester form-control" id="semester"  name="semester" value="<?php echo $billto["semester"]; ?>" /><input type="hidden" id="desg" class="desg" value="<?php echo $billto["semester"]; ?>" /><span class="error_msg" style="color:#F00;"></span> <span class="error_msg1" style="color:#F00;"></span></td>
                            </tr>
                            <tr>
...
if (isset($list) && !empty($list)) {
    foreach ($list as $billto) {
        ...
        <div id="test2_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">In-Active Term</h3>
                    </div><div class="modal-body">
                        Do you want to In-Active? &nbsp; <strong><?php echo $billto["semester"]; ?></strong>
...
if (isset($list) && !empty($list)) {
    foreach ($list as $billto) {
        ...
        <div id="test3_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">Delete Term</h3>
                    </div><div class="modal-body">
                        Do you want delete permanently? &nbsp; <strong><?php echo $billto["semester"]; ?></strong>
