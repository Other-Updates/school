...
class Group extends CI_Controller {
    ...
    function insert_group() {
        ...
        foreach ($g_array as $val) {
            if ($val != '') {
                $insert = array('depart_id' => $post_val['depart_id'], 'group' => $val, 'board_id' => $post_val['board_id']);
    ...
    function update_group() {
        ...
        if ($i == 1) {
            ...
            $data['all_depart'] = $this->group_model->get_all_department();
            $update_data = array('depart_id' => $postval['udepart_id'], 'group' => $postval['update_group'], 'status' => $postval['update_status'], 'board_id' => $postval['board_id']);
