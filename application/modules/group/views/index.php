...
<table class="form_table">
    ...
    <tr>
        ...
        <td>
            <table id='app_table'>
                <tr><?php $i = 0; ?>
                    <td width="15%"><input type="text" class='group length sec_dup' name='group[]' id="test" placeholder="Type Section"/>
...
if (isset($g_list) && !empty($g_list)) {
    ...
    foreach ($g_list as $val) {
        ?>
        <div id="view_<?= $val['id'] ?>" class="modal fade in close_div" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"   align="center">
                    ...
                    <div class="modal-body">
                        <table width="100%" class="staff_table_sub">
                            <tbody>
                                ...
                                <tr>
                                    <td>Class</td>
                                    <td class="text_bold1"><?php echo $val['department'] ?> </td>
                                </tr>
                                <tr>
                                    <td>Section</td>
                                    <td class="text_bold1"><?php echo $val['group'] ?></td>
                                </tr>
                                <tr>
                                    <td>Board</td>
                                    <td class="text_bold1"><?php echo $val['board_type'] ?></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td class="text_bold1"><?php echo ($val['status'] == 1) ? 'Active' : 'In-Active'; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script type="text/javascript">
    ...
    $('.update_btn').live('click', function () {
        ...
        var board_type = $(this).parent().parent().find('.board_type').val();
