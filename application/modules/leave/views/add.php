...
<div class="add_staff">
    ...
    <form method="post" action="<?php echo $this->config->item('base_url') . 'leave/add_leave/'; ?>"  enctype="multipart/form-data" onsubmit="return validate();">
	<table class="staff_table">
	    <tr>
		<td>Leave Duration</td>
		<td><select name="leave_duration" id="leave_duration" class="required form-control"  tabindex="1">
			<option value="">Select</option>
			<option value="1">Half Day Leave</option>
			<option value="2" >Full Day Leave</option>
			<option value="3">Permission</option>
		    </select>
		    <span id="v1" class="error" style="color:#F00;"></span></td>
		<td>Leave Type</td>
		<td>
		    <select name="leave_type" id="leave_type" class="required form-control"  tabindex="2">
			<option value="">Select</option>
			<option value="1" selected>Casual Leave (CL)</option>
			<option value="2">Seek Leave (SL)</option>
			<option value="3">Others</option>
		    </select>
		    <span id="v2" class="error" style="color:#F00;"></span></td>

	    </tr>
	    <tr class="leave_section">
		<td style="vertical-align:top">Leave From</td>
		<td><input type="text"  class='from_date required' name='from_date' id="from_date" tabindex="3" />
		    <span id="v3" class="error" style="color:#F00;"></span></td>
		<td style="vertical-align:top">Leave To</td>
		<td><input type="text"  class='to_date required' name='to_date' id="to_date" tabindex="4" />
		    <span id="v4" class="error" style="color:#F00;"></span></td>
	    </tr>
	    <tr class="permission_section" style="display: none">
		<td style="vertical-align:top">Permission From</td>
		<td><input type="text"  class='required ' name='from_date' id="from_time" tabindex="5" />
		    <span id="v5" class="error" style="color:#F00;"></span></td>
		<td style="vertical-align:top">Permission To</td>
		<td><input type="text"  class='required' name='to_date' id="to_time" tabindex="6" />
		    <span id="v5" class="error" style="color:#F00;"></span></td>
	    </tr>
		...
		<td>
			...
			<option value="">Select</option>
			<option value="1">Forenoon (FN)</option>
			<option value="2">Afternoon (AN)</option>
		    </select>
		    <span id="v4" class="error" style="color:#F00;"></span> </td>
		<td></td>
		<td></td>
	    ...
	    <tr>
		<td>Reason</td>
		<td colspan="3"><textarea tabindex="8" name="reason" id="reason" class="required form-control" placeholder="Reason"></textarea>
		    <span id="v5" class="error" style="color:#F00;"></span></td>
		<td></td>
		<td></td>
	    </tr>
	...
	$('#leave_duration').change(function () {
		...
		if (leave_duration == 1) {
			...
			onChangeDateTime: function (dp) {
			    ...
			    $('.leave_section').find('#to_date').datetimepicker({minDate: year + '/' + month + '/' + date});
			}
		    });
		    $('.leave_section').find('#to_date').attr("onclick", 'return false;');
		    $('.leave_section').find('#to_date').attr("readonly", "readonly");
			...
			onChangeDateTime: function (dp) {
			    ...
			    $('#to_time').datetimepicker({minDate: year + '/' + month + '/' + date});
		...
		$('.permission_section').find('#to_time').datetimepicker({
		    ...
		    timepicker: true,
		    format: 'd-m-Y H:i',
		    allowTimes: ['00:15', '00:30', '00:45', '01:00', '01:15', '01:30', '01:45', '02:00',
			'02:15', '02:30', '02:45', '03:00', '03:15', '03:30', '03:45', '04:00', '04:15',
			'04:30', '04:45', '04:00', '05:15', '05:30', '05:45', '05:00', '05:15', '05:30',
			...
			'17:00', '17:15', '17:30', '17:45', '17:00', '18:15', '18:30', '18:45', '19:00', , '19:15', '19:30', '19:45', '20:00', '20:15', '20:30', '20:45', '21:00', '21:15', '21:30', '21:45', '22:00', '22:15', '22:30', '22:45', '23:00'
		    ],
		    pickSeconds: true,
		    autoclose: true
		});
