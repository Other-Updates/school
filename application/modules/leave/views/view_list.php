 <?php $staff=$this->session->userdata('logged_in'); ?><?php if(isset($master) && !empty($master)){
           ...
           <tr>
            ...
            <tr>
                ...
                <select id='staff' name='student_staff'  class="u_staff mandatory validate">
                             ...
                             <?php $this->load->model('subject/subject_model');$all_stf=$this->subject_model->get_all_staff($update['depart_id']);?>
				<?php 
