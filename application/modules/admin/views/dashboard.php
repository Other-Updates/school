<style>
    .box{ background:#eff3f6; box-shadow:none;}
    .box1 {background: #ffffff;box-shadow: 1px 0px 20px rgba(0, 0, 0, 0.05);
    }
</style>
...
<div class="row">
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'student' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/student2.png" /></div>
    ...
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'staff' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/staff.png" /></div>
                <div class="info-box-tit">Staff
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'subject' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/subject.png" /></div>
                <div class="info-box-tit">Subject
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'attendence' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/calendar.png" /></div>
                <div class="info-box-tit">Attendance
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'chat/adminchat' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/chat.png" /></div>
                <div class="info-box-tit">Chat
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-2">
        <a href="<?= $this->config->item('base_url'), 'internal/internal_exam_result' ?>">
            <div class="info-box">
                <div class="info-box-img"><img src="<?= $theme_path; ?>/img/icons/exam.png" /></div>
                <div class="info-box-tit">Exam
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-3 col-12">
            <div class="info-box bg-b-green">
                <div class="info-box-icon push-bottom"><i class="ion-ios7-people"></i></div>
                <div class="info-box-content">
                    <span class="info-box-text">Today Students</span>
                    <span class="info-box-number"><?php echo ($s_attend) ? $s_attend : 0; ?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width:  <?php echo ($s_attend / $students) * 100 . '%' ?>"></div>
                    </div>
                    <span class="progress-description">
                        <?php echo ($s_attend / $students) * 100 . '%' ?> Attendance
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-xl-3 col-md-3 col-12">
            <div class="info-box bg-b-yellow">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Today Staffs</span>
                    <span class="info-box-number"><?php echo ($s_staff) ? $s_staff : 0; ?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo ($s_staff / $staff) * 100 . '%' ?>"></div>
                    </div>
                    <span class="progress-description">
                        <?php echo ($s_staff / $staff) * 100 . '%' ?> Attendance
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-xl-3 col-md-3 col-12">
            <div class="info-box bg-b-purple">
                <div class="info-box-icon push-bottom"><i class="ion-android-book"></i></div>
                <div class="info-box-content">
                    <span class="info-box-text">Today Events</span>
                    <span class="info-box-number"><?php echo ($event) ? $event : 0; ?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo ($event / $events) * 100 . '%' ?>"></div>
                    </div>
                    <span class="progress-description">
                        <?php echo ($event / $events) * 100 . '%' ?> Events
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-xl-3 col-md-3 col-12">
            <div class="info-box bg-b-pink">
                <div class="info-box-icon push-bottom"><i class="ion-android-calendar"></i></div>
                <div class="info-box-content">
                    <span class="info-box-text">Today Orders</span>
                    <span class="info-box-number"><?php echo ($day) ? $day : 0; ?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo ($day / $day_order) * 100 . '%' ?>"></div>
                    </div>
                    <span class="progress-description">
                        <?php echo number_format(($day / $day_order) * 100, 0) . '%' ?> Day Order
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
...
<div class="">
    ...
    <div class="row">
        ...
        <section class="col-lg-6">
            <div class="box box1 box-warning">
        ...
        <section class="col-lg-6">
            <div class="box1 box box-danger"><div class="box-header"><h3 class="box-title">Recent Activity</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <ul class="todo-list">
                        <?php
                            ...
                            foreach ($all_notification as $val) {
                                if (isset($val['links']) && !empty($val['links'])) {
                                    ...
                                    <li class="li_<?= $val['id'] ?>">
                                        ...
                                        <span class="text">
                                            <?php if ($val['user_type'] != 'student') { ?>
                                                <a href="<?= $this->config->item('base_url') . $val['links'] ?>" ><?= $val['notification'] ?></a>
                                            <?php } else { ?>
                                                <a href="javascript:void(0)" title="Go to student login"><?= $val['notification'] ?></a>
                                            <?php } ?>
                                        </span>
