...
<table  class='print_admin_use staff_table'>
    	<tr>
            ...
            <td  width="25%">
            	<input type="text"  id='company_name' name='company_name' value="<?=$get_placement[0]['company_name']?>" />
                <span id="cp1" style="color:#F00;"></span>
            </td>
            <td  width="12%">Venue</td>
            <td  width="25%">
            	<input type="text" id='venue'  name='venue'  value="<?=$get_placement[0]['venue']?>"/>
                <span id="cp2" style="color:#F00;"></span>
            </td>
            <td  width="12%">Date</td>
            <td  width="25%">
            <div class="input-group">
                ...
                <input type="text"  name='reservation' id="reservation"  value="<?=$get_placement[0]['date']?>">
                <span id="cp3" style="color:#F00;"></span>
            </div><!-- /.input group -->
        ...
        <tr>
        	<td>Comments</td>
            <td  colspan="5"><textarea class="form-control" id='company_comment'  name='company_comment' rows="3" style="width:100%" ><?=$get_placement[0]['comments']?></textarea><span id="cp4" style="color:#F00;"></span>
            </td>
        </tr>
        <tr>
        	<td width="10%">Salary</td>
            <td  width="5%">
            	<input type="text" id='salary' name='salary'  value="<?=$get_placement[0]['salary']?>"/>
                <span id="cp5" style="color:#F00;"></span>
            </td>
            <td  width="8.25%"></td>
            <td  width="10%">
            </td>
...
<p>
      <input type="submit" value="Update" class="btn btn-success submit" style="float:right;"  id="add_interview" /> <br /><br />
</p>
     <script type="text/javascript">
