...
class Student_promotion extends MX_Controller {
    ...
    public function get_all_student_with_subject() {
        ...
        if ($board_id == 2) {
            echo $this->load->view('student_promotion/student_details_cbse', $data);
        } else {
    ...
    public function switch_over_students() {
        ...
        if ($board_id == 2) {
            $students = $this->student_promotion_model->get_all_student_result_cbse($input);
        } else {
        ...
        $new_group = $this->student_promotion_model->get_next_group_id($group_id);
        $new_session_id = $this->student_promotion_model->get_next_section_id($depart_id, $new_group);
        ...
        if (isset($students) && !empty($students)) {
            ...
            $this->student_promotion_model->update_external_status($update, $batc_id, $depart_id, $group_id, $semester, $board_id);
        }
