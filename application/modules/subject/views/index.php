...
<!--        <td width="10%">Term </td>
       <td>
        ...
        <tr>
            ...
            <td>Board</td>
            <td id='board_td'>
                <select name="board_id" id="board" class="board_type validate mandatory"  disabled="disabled">
                    <option value="">Select</option>
                </select>
            </td>
        </tr>
            ...
            <td colspan="3">
                <?php if (isset($row['subject']) && !empty($row['subject'])) { ?>
                    <?php if ($staff['staff_type'] == 'admin' && $row['subject'] == 1 || $staff['staff_type'] == 'staff' && $row['subject'] == 1) { ?>
                        ...
                        <button type="button" class="btn btn-warning add_bluk_import"><i class="fa fa-upload position-left"></i> Import Subject</button>                    <?php
                    }
                }
                ?>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo $this->config->item('base_url') . 'subject/import_subject'; ?>" enctype="multipart/form-data" name="" method="post" id="student_data">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $this->config->item('base_url') . 'attachement/subject/sample_subject.csv'; ?>" download><i class="fa fa-download"></i>&nbsp; Sample Subject</a>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" name="" id="cancel2" class="btn btn-warning" data-dismiss="modal">Cancel</button>
                    </div>
    ...
    <table  class="show-me1 form_table1" id="cls1" width="100%" border="0" style="display:none">

        <tr>
            <td width="10%">Subject:</td>
            <td width="23%">
                <input type="text" id="sub1" class="subject1 mandatory validate" />
            </td>
            <td width="10%">Nick Name:</td>
            <td width="23%">
                <input type="text" id="nicky1" class="nick_sub1 mandatory validate" />
            </td>
            <td width="10%">Subject Code</td>
            <td width="20%"><input type="text" id="scode1" name="scode1" class=" validate mandatory duplication" maxlength="10" /></td>
            <td> </td>
        ...
        <tr>
            ...
            <td width="25%">
                <select  name='student_group'  class="u_department1 mandatory staff1 validate depar1">
                    <option value="">Select</option>
                    <?php
                    if (isset($all_department) && !empty($all_department)) {
                        foreach ($all_department as $val) {
            ...
            <td>Staff</td>
            <td id='s_view1'>
                <select id='staff1' name='student_staff'  class="u_group1 mandatory validate dupe1">
                    <option value="">Select</option>
                </select>
            </td>
            <td><span style="color:#F00" id="dupli1" class="len"> </span></td>
        </tr>
        <tr>
            <td>Credits</td>
            <td><input type="text" id="grade_point1" class="int_val validate mandatory" /></td>
        </tr>
        <tr>
            <td></td><td></td><td><span style="color:#F00" id="valu"> </span></td>
            <td>
                <input type="button" value="Save" id="add_subject1" class="btn btn-primary dis"  />
                <input type="reset" value="Cancel" id="cancel1" class="btn btn-danger" />
            </td>
        </tr>
    </table>
    ...
    <table  class="show-me form_table" id="cls" width="100%" border="0" style="display:none">
        ...
        <tr>
            ...
            <td width="25%" id='s_view'>
                <select id='staff' name='student_staff'  class="mandatory validate dupe">
                    <option value="">Select</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="reset" value="Cancel" id="cancel3" class="btn btn-danger " />
            </td>
        </tr>
    </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding:5px">
                        <table class="staff_table_sub">
                            ...
                            <tr>
                                <td>Board</td><td class="text_bold1"> <?php echo $view['board_type']; ?></td>
                            </tr>
                            <tr>
                    ...
                    <div class="modal-footer" style="margin-top:2px; padding: 9px 10px 10px;">
                        ...
                        <div class="box-body table-responsive">
                            <div id="subject">
                                <table width="100%" border="0" class="form_table" >
                                    ...
                                    <input type="hidden" name="batch" value="<?php echo $update['batch_id'] ?>"  id="batc" class="batc u_batch"/>
                                    <input type="hidden" name='semester' value="<?php echo $update['semester_id'] ?>" id="sem" class="sem u_semester" />
                                    <tbody>
                                        <tr>
                                            <td>Class</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Section </td>
                                            <td class='u_td<?= $i ?>'>
                                                <select  name='group' id='group_<?= $i ?>' class="mandatory u_group u_val mandatory" >
                                                    <?php
                                        ...
                                        <tr>
                                            <td>Board</td>
                                            <td class='u_board_td<?= $i ?>'>
                                                <select id='board' name='board'  class="mandatory u_board u_val mandatory" >
                                                    <option value="<?= $update['board_id'] ?>"> <?= $update['board_type'] ?> </option>
                                                </select>
                                                <input type="hidden" value="<?php echo $update['board_id'] ?>" id="boards" class="boards" />
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody class="cbse" style="display:<?php echo ($update['board_id'] == 2) ? '-' : 'none'; ?>">
                                        <tr>
                                            <td>Credits</td>
                                            <td>
                                    ...
                                    <tbody class="state" style="display:<?php echo ($update['board_id'] == 1) ? '-' : 'none'; ?>">
                                        <tr>
                                            <td>Total Mark </td>
                                            <td>
                                                <input type="text" class="u_grade u_val mandatory"  value="<?php echo $update['grade_point']; ?>" />
                                        ...
                                        <tr>
                                            ...
                                            <td>  <input type="checkbox" id="u_check_practical"  value="<?php echo $update['check_practical']; ?>" class="u_check_practical" <?php echo ($update['check_practical'] == 1) ? 'checked' : ''; ?>/> If You Want Practical Mark?</td>
                                        </tr>
    ...
    $(document).ready(function () {
        ...
        $("#add_subject").click(function ()
        {
            ...
            if (board == '') {
                ...
                $('#board').css('border', '1px solid #CCCCCC');
            }
            ...
            if (i == 0)
            {
                ...
                if (check_practical == 1) {
                    datas = {value1: batch, value2: department, value3: group, value4: semester, value5: staff, value6: subject, value8: scode,
                        value9: nick, grade: grade, pass_mark: pass_mark, check_practical: check_practical, practical_pass_mark: practical_pass_mark, practical_mark: practical_mark, board: board};
                } else {
                    datas = {value1: batch, value2: department, value3: group, value4: semester, value5: staff, value6: subject, value8: scode,
                        value9: nick, grade: grade, pass_mark: pass_mark, board: board};
                }
        ...
        $("#add_subject1").click(function ()
        {
            ...
            var subject = $("#sub1").val();
            var nick = $("#nicky1").val();
            var grade = $("#grade_point1").val();
            var staff_dep = $(".depar1").val();
            var board = $("#board").val();
            var i = 0;
            if (board == '') {
                i = 1;
            ...
            if (staff == '') {
                i = 1;
                $('#staff1').css('border', '1px solid red');
            } else {
                $('#staff1').css('border', '1px solid #CCCCCC');
            }
            if (subject == '' || subject.trim().length == 0) {
                i = 1;
                $('#sub1').css('border', '1px solid red');
            } else {
                $('#sub1').css('border', '1px solid #CCCCCC');
            }
            if (scode == '' || scode.trim().length == 0) {
                i = 1;
                $('#scode1').css('border', '1px solid red');
            } else {
                $('#scode1').css('border', '1px solid #CCCCCC');
            }
            if (nick == '' || nick.trim().length == 0) {
                i = 1;
                $('#nicky1').css('border', '1px solid red');
            } else {
                $('#nicky1').css('border', '1px solid #CCCCCC');
            }

            if (staff_dep == '' || staff_dep == null || staff_dep == 0) {
                i = 1;
                $('.depar1').css('border', '1px solid red');
            } else {
                $('.depar1').css('border', '1px solid #CCCCCC');
            }

            if (grade == '' || grade.trim().length == 0) {
                i = 1;
                $('#grade_point1').css('border', '1px solid red');
            } else {
                $('#grade_point1').css('border', '1px solid #CCCCCC');
            }
            ...
            if (i == 0)
            {
                $.ajax({
                    ...
                    data: {value1: batch, value2: department, value3: group, value4: semester, value5: staff, value6: subject, value8: scode,
                        value9: nick, grade: grade, board: board},
                    success: function (result) {
        ...
        $("#cancel1").click(function () {
            ...
            $('.validate').css('border', '1px solid #CCCCCC');
            $('.mandatory').css('border', '1px solid #CCCCCC');
            $("#phone1").css('border', '1px solid #CCCCCC');
        });
        ...
        $("#update").live("click", function () {
            ...
            var board = $(this).parent().parent().find('.u_board').val();
            var group = $(this).parent().parent().find('.u_group').val();
            ...
            if (i == 0)
            {
                if (check_practical == 1) {
                    datas = {value1: id, value2: subject, value3: staff, value4: batch, value5: group, value6: semester,
                        value7: department, value8: scode, value9: nickname, grade: grade, pass_mark: pass_mark, check_practical: check_practical, practical_pass_mark: practical_pass_mark, practical_mark: practical_mark, board: board};
                } else {
                    datas = {value1: id, value2: subject, value3: staff, value4: batch, value5: group, value6: semester, value7: department, value8: scode, value9: nickname, grade: grade, pass_mark: pass_mark, check_practical: check_practical, board: board};
                }
...
//            m.html
        ...
        $('#department').live('change', function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    $('#g_td').html(result);
                    $('#board_td').html('<select name="board_id" id="board" class="board_type validate mandatory"  disabled="disabled"><option value="">Select</option></select>');
                    $('#group1').focus();
                    $("#cls").hide();
                    $("#cls1").hide();
        ...
        $('#group1').live('change', function () {
            ...
            d_id = $(this).val();
            $.ajax({
                url: BASE_URL + "subject/get_all_board",
                type: 'POST',
                data: {
                    group_id: d_id
        ...
        $('.u_group').live('change', function () {
            grp_id = $(this).parent().parent().find('.u_group').val();
            idnum = ($(this).attr('id'));
            var splitNumber = idnum.split('_');
            var ids = splitNumber[1];

            $.ajax({
                url: BASE_URL + "subject/get_all_bd",
                type: 'POST',
                data: {
                    grp_id: grp_id
                ...
                success: function (result) {
                    $('.u_board_td' + ids).html(result);
                    var board = $('.u_board_td' + ids).find('.u_board').val();
                    if (board != '') {
                        if (board == 2) {
                            $(".cbse").show();
                            $(".state").hide();
        ...
        $('.staff1').live('change', function () {
            d_id = $(this);
            $.ajax(
                    {
                        url: BASE_URL + "subject/get_all_staff1",
                        type: 'POST',
                        data: {depart_id: d_id.val()},
                        success: function (result) {
