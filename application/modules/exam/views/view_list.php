    ...
    foreach ($list as $billto) {
        ...
        <div id="test_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header">
                        <a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">View Exam</h3></div><div class="modal-body">
                        ...
                        <table width="100%">
                           ...
                           <!-- <td><strong>Id:</strong></td>-->
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="exam form-control" id="exam"  name="exam" value="<?php echo $billto["exam"]; ?>" /><input type="hidden" id="desg" class="desg" value="<?php echo $billto["exam"]; ?>" /><span class="error_msg" style="color:#F00;"></span> <span class="error_msg1" style="color:#F00;"></span></td>
                            </tr>
                            <tr>
...
if (isset($list) && !empty($list)) {
    foreach ($list as $billto) {
        ...
        <div id="test2_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">In-Active Exam</h3>
...
if (isset($list) && !empty($list)) {
    foreach ($list as $billto) {
        ...
        <div id="test3_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3 id="myModalLabel">Delete Exam</h3>
                    </div><div class="modal-body">
