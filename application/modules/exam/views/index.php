<div class="box-body table-responsive">
    <table width="100%" border="0" class="form_table">
        <tr>
            <td width="110"><b>Add Exam</b></td>
            <td><input type="text" name="exam"  value="" class="mandatory mandatory6" placeholder="Enter Exam"  id="name" maxlength="50"/> </td>
        <tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><a class="close" data-dismiss="modal">×</a>
                        <h3 id="myModalLabel">Exam View</h3>
                    </div>
                    <div class="modal-body">
                        <table width="100%" class="staff_table_sub">
                            <tr>
                                <?php /* ?><td><strong>S.No</strong></td> <td><?php echo $billto["id"]; ?></td></tr><tr><?php */ ?>
                                <td><strong>Exam</strong></td> <td class="text_bold1"><?php echo $billto["exam"]; ?></td></tr><tr>
    ...
    foreach ($details as $billto) {
        ...
        <div id="test1_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><a class="close" data-dismiss="modal">×</a>
                        <h3 id="myModalLabel">Update Exam</h3>
                    </div>
                    <div class="modal-body">
                        <table width="100%">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="exam form-control" id="exam"   name="exam" value="<?php echo $billto["exam"]; ?>" /><span class="error_msg" style="color:#F00;"></span> <span class="error_msg1" style="color:#F00;"></span><input type="hidden" id="desg" class="desg" value="<?php echo $billto["exam"]; ?>" /></td>
                            </tr>
                            <tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"> <a class="close" data-dismiss="modal">×</a>
                        ...
                        <h3 id="myModalLabel">In-Active Exam</h3>
                    </div>
                    <div class="modal-body">
                        Do You Want to In-Active? &nbsp; <strong><?php echo $billto["exam"]; ?></strong>
...
if (isset($details) && !empty($details)) {
    foreach ($details as $billto) {
        ...
        <div id="test3_<?php echo $billto['id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
            <div class="modal-dialog"><div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h4>Delete Exam</h4><h3 id="myModalLabel">
                    </div><div class="modal-body">
                        Do you want delete Permanently? &nbsp; <strong><?php echo $billto["exam"]; ?></strong>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("#name").live('keyup', function ()
        {
            ...
            $.ajax(
                    {
                        url: BASE_URL + "exam/checking_exam",
                        type: 'POST',
                        data: {value1: name},
                        success: function (result)
                        {
        ...
        {
            var exam = $(this).parent().parent().find(".exam").val();
            var i = 0;
            ...
            if (exam.trim().length < 2 || exam.trim().length > 50)
            {
                //alert("alert");
            ...
            $.ajax(
                    {
                        url: BASE_URL + "exam/checking_Update",
                        type: 'POST',
                        data: {value1: exam, value2: id},
                        success: function (result)
                        {
                            //alert(result);
            ...
            if (i == 0 && message1.trim().length == 0)
            {
                ...
                $.ajax({
                    url: BASE_URL + "exam/update_exam",
                    type: 'POST',
                    data: {value1: id, value2: exam, value3: status},
                    success: function (result) {
        ...
        $("#no").live("click", function ()
        {
            var $a = desg = $(this).parent().parent().parent().find('.desg').val(),
                    ...
                    $c = exam = $(this).parent().parent().find('.exam').val(),
                    $d = status = $(this).parent().parent().find('.status').val();
            exam = $(this).parent().parent().find('.exam').val(''),
                    exam = $(this).parent().parent().find('.exam').val($a),
        ...
        $("#yesin").live("click", function ()
        {
            ...
            $.ajax({
                url: BASE_URL + "exam/delete_exam_inactive",
                type: 'POST',
                data: {value1: hidin},
                success: function (result) {
