...
<table>
    ...
    <tr><td>Academic Year</td><td>:</td><td class="text_bold"><?= $fees_info[0]['from']; ?></td></tr>
    <tr><td>Class</td><td>:</td><td class="text_bold"><?= $fees_info[0]['department'] . '-' . $fees_info[0]['group'] ?></td></tr>
...
<div id='exam_info'>
    <div class="fees_tit">Term / Other Fees</div>
    <?php
    if (isset($fees_info[0]['exam_info']) && !empty($fees_info[0]['exam_info'])) {
        foreach ($fees_info[0]['exam_info'] as $val) {
            $complete_status = 0;
        ...
        echo "No Term / Other Fees for this Student...";
    }
    ?>
</div>
<div id='hostel_info'>
