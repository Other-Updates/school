            ...
            <table>
                    ...
                    <tr class='type_tr' style="display:<?=($fees_info[0]['fain']=='no')?'none':''?>">
                     ...
                     <tr class='amt_tr' style="display:<?=($fees_info[0]['fain']=='no')?'none':''?>">
                        <td></td>
                        <td></td>
                        <td><input type="text" value='<?=$fees_info[0]['fain_amount']?>' name='fees_info[fain_amount]' style="width:100px; float:left;" class='fain_amt' /><span  style="position: relative; left: 6px;top: 6px;"  class='per_fees_type'> <?=ucfirst($fees_info[0]['fain_type'])?> / Day</span> </td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    <td></td>
