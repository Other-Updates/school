        ...
        if (isset($all_grade[0]['external_details']) && !empty($all_grade[0]['external_details'])) {
            ...
            foreach ($all_grade[0]['external_details'] as $val) {
                ...
                <tr>
                    ...
                    ?>
                    <td style="text-align:center;"><?= $val1['total'] ?></td>
                    <td style="text-align:center;">
                        <label class="btn btn-<?php echo ($val1['result'] == '1') ? 'success' : 'danger' ?> btn-sm"><?php echo ($val1['result'] == '1') ? 'Pass' : 'Fail' ?></label>
                    </td>
                    <td class="header" style="text-align:center;">
                        <a href="<?= $this->config->item('base_url') . 'users/mark_sheet/' . $user_info[0]['id'] . '/' . $all_post['exam_id']; ?>" title="Mark Sheet" target="_blank" class="btn btn-info btn-sm ">View</a>
                    </td>
                </tr>
                <?php
                $j++;
