...
<button type="button" class="btn btn-success add_bluk_import"><i class="fa fa-upload position-left"></i> Import Staff</button>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo $this->config->item('base_url') . 'attachement/staff/sample_staff.csv'; ?>" download><i class="fa fa-download"></i>&nbsp; Sample Staff</a>
                                </div>
